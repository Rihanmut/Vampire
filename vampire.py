...
TELEGRAM_BOT_TOKEN = '7658149247:AAGwAcxgfAN2uA2ESKn_Dti9B4Xju-8BupU'
ADMIN_USER_ID = 6620622287  
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @RIJUDDOS💥*"
    ), parse_mode='Markdown')
